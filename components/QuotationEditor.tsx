    ...
    <div className="w-full bg-surface dark:bg-dark-surface rounded-lg p-4 md:p-6 border border-border dark:border-dark-border shadow-sm">
      ...
      <div className="hidden md:block overflow-x-auto">
        <table className="w-full text-sm text-left text-textSecondary dark:text-dark-textSecondary">
          <thead className="text-xs text-textSecondary dark:text-dark-textSecondary uppercase border-b border-border dark:border-dark-border">
            <tr>
          ...
          <tbody>
            {items.map((item) => (
              <tr key={item.id} className="border-b border-border dark:border-dark-border last:border-b-0 hover:bg-black/5 dark:hover:bg-white/5">
                ...
                <td className="px-4 py-2 text-center">
                   <button onClick={() => removeItem(item.id)} className="text-red-500 hover:text-red-400 p-1 rounded-full hover:bg-red-500/10 dark:hover:bg-red-500/10">
                      <Trash2 size={16} />
                   </button>
                </td>
              </tr>
